...
class TransactionStatus
{
    ...
    public function trStatus($paytoken, $mp = false, $n_json = false)
    {
        $ch = curl_init();
        $link = $mp ? '/mp/paymentstatus/' : '/cashout/paymentstatus/';
        ...
        $auth_resp_json = $n_json ? $auth_resp_json : json_decode($auth_resp_json);
